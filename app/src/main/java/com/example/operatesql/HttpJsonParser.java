...
public class HttpJsonParser {
    ...
    public JSONObject makeHttpRequest(String url, String method,
        ...
        //Map<String, String> params : collection of strings



        try {
            Uri.Builder builder = new Uri.Builder(); //Immutable URI reference. A URI reference includes a URI and a fragment, the component of the URI following a '#'. Builds and parses URI references which conform to RFC 2396 .
            URL urlObj;
            String encodedParams = "";

            //create a query of server
            if (params != null) {
                //key value pair
